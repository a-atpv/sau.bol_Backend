...
class AiService:
    ...
    def get_recommendations(self, symptoms: List[str]) -> str:
        ...
        user_message = ""
        if len(symptoms) == 0:
            user_message = "я мужчина меня зовут алдияр, мой рост 182 см, вес 66 кг , \
            ...
            user_message = f"я мужчина меня зовут алдияр, мой рост 182 см, вес 66 кг , \
            У меня возможно есть такие проблемы: {symptoms_text} \
