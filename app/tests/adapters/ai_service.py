    ...
    def _generate_user_message(self, symptoms: List[str]) -> str:
        if len(symptoms) == 0:
            user_message = (
                ...
                "Привычки должны быть конкретными и не должны быть больше 10 слов. "
                ...
                '"analysis": ["анализ 1", "анализ 2", "анализ 3"], '
                '"explanation": "объяснение почему именно эти анализы", '
                '"habits": ["привычка 1", "привычка 2, "привычка 3 (прием витаминов/минералов)""], '
